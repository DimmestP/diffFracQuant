...
// latent counts
  ...
  for(con in 1:NCON){
    sup_latent[con] = gene_count_base + gene_count_condition[con];
    pel_latent[con] = gene_count_base + gene_count_condition[con] + pel_count_condition[con];
  }
}
...
gene_count_base ~ normal(norm_alpha, norm_beta);
...
for(con in 1:NCON){
    ...
    // latent counts
    gene_count_condition[con] ~ normal(0, 1);
