...
for(con in 1:NCON){
    ...
    for(rep in 1:NREP){
        ...
        // total
        tot_obs[con, rep] ~ neg_binomial_2(tot_scale_factor[con, rep] * (sup_latent[con] + pel_latent[con]), phi[con, 1]);
      }
  }
}
generated quantities{
	...
	for(con in 1:NCON){
		tot_obs_sim[con] = neg_binomial_2_rng(tot_scale_factor[con, 1] * (sup_latent[con] + pel_latent[con]), phi[con, 1]);
	}
}',
