...
model{
  ...
  for(con in 1:NCON){
    tot_scale_factor[con] ~ normal(10, 1);
    pel_scale_factor[con] ~ normal(10, 1);
    sup_scale_factor[con] ~ normal(10, 1);
    ...
    pel_latent[con] ~ lognormal(pel_gamma_alpha, pel_gamma_beta);
      ...
      for(rep in 1:NREP){
        ...
        // total
        tot_obs[con, rep] ~ neg_binomial_2(tot_scale_factor[con, rep] * (sup_latent[con] + pel_latent[con]), phi);
      }
  }
}',
