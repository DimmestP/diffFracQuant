...
collect_size_factors_simulated <- sizeFactors(DESeq2_data_set_simulated_specific) |>
  as_tibble(rownames = "label") |>
  bind_rows(sizeFactors(DESeq2_data_set_simulated_marginal) |>
  as_tibble(rownames = "label")) |>
  bind_rows(sizeFactors(DESeq2_data_set_simulated_random) |>
  as_tibble(rownames = "label")) |>
  separate(label, into = c("condition", "rep", "frac"))
```
...
write_tsv(collect_size_factors_simulated,
          here("./data/output/diff_frac_models/DESeq2_simulated_size_factors.tsv"))
