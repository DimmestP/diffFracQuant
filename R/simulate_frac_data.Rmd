...
```{r output-sim-counts, eval=FALSE}
...
write_tsv(total_sup_pel_simulated_mean_counts_skewed_multi_condition, here("data/output/simulated_counts/sup_pel_noiseless_fractions.tsv"))

write_tsv(tot_sup_pel_scale_factor_multi_condition,
          here("data/output/simulated_counts/tot_sup_pel_scale_factor_multi_condition.tsv"))
```
